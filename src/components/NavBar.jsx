...
// /**
//  * NavBar组件，用于显示网站的导航栏。
//  * @returns {JSX.Element} NavBar组件的JSX元素。
//  */
const NavBar = () => {
  return (
    <header id="navbar" className="nav">
      <div className="nav_padding">
        <div className="nav_wrapper">
          <a id="firework-logo-home-link" href="https://firework.com/"
            aria-label="Go to Home page"
            className="nav_brand w-node-_92c48947-d98a-4b7d-e09e-72ff81540263-81540260 w-nav-brand">
            <div id="firework-logo-home-link" className="navbar_brand-img w-embed"><svg width="144" height="26"
                viewBox="0 0 144 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                ...
                <path
                  ...
                  fill="currentcolor" />
                <path d="M58.2096 7.76135H55.8672V22.3659H58.2096V7.76135Z" fill="currentcolor" />
                <path
          ...
          <div id="w-node-_92c48947-d98a-4b7d-e09e-72ff81540265-81540260" className="nav_menu_wr">
            <nav data-wf--nav-menu--variant="no-pricing"
              className="nav_menu w-variant-6c5a36d4-fb94-3a14-f3f1-62e8a56848cf">
              <div data-delay="0" data-hover="true" id="nav-products-dropdown"
                data-w-id="60cce809-05e0-36f2-fe7a-0d58cf470b62" className="nav_dd w-dropdown">
                <div className="nav_dd_toggle w-dropdown-toggle">
                  <div>Products</div>
                  <div className="nav_dd_icon w-embed">
                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fillRule="evenodd" clipRule="evenodd"
                        d="M12.3977 16.1629C12.178 16.3826 11.8219 16.3826 11.6022 16.1629L5.86739 10.428C5.64772 10.2084 5.64772 9.85227 5.86739 9.63259L6.13256 9.36739C6.35222 9.14772 6.70838 9.14772 6.92805 9.36739L12 14.4393L17.0719 9.36739C17.2916 9.14772 17.6477 9.14772 17.8674 9.36739L18.1326 9.63259C18.3522 9.85227 18.3522 10.2084 18.1326 10.428L12.3977 16.1629Z"
                        fill="currentcolor" />
                    </svg>
                  </div>
                </div>
                <nav className="nav_dd_list w-dropdown-list">
                  <div className="nav_dd_content-wr">
                    <div className="nav_dd_product_container">
                      <div className="nav_dd_product_layout">
                        <a id="nav-ai-virtual-assistant-link"
                          href="https://firework.com/solutions/meet-ava/"
                          className="nav_dd_product_link nav_btn_interaction w-node-c028b475-58ac-9405-5469-782d1b742d61-1b742d5f w-inline-block">
                          <img
                            src="static/picture/671a6f95b8389a69fbc382d2_ai-digital-assistant-nav.webp" loading="lazy"
                            sizes="100vw"
                            srcSet="https://cdn.prod.website-files.com/66a003afc59794bcf70c2b34/671a6f95b8389a69fbc382d2_ai-digital-assistant-nav-p-500.webp 500w, https://cdn.prod.website-files.com/66a003afc59794bcf70c2b34/671a6f95b8389a69fbc382d2_ai-digital-assistant-nav-p-800.webp 800w, https://cdn.prod.website-files.com/66a003afc59794bcf70c2b34/671a6f95b8389a69fbc382d2_ai-digital-assistant-nav.webp 864w"
                            alt="" className="nav_dd_product_link_img" />
                          <div className="nav_dd_product_link_text-wr">
                            <div id="w-node-c028b475-58ac-9405-5469-782d1b742d64-1b742d5f"
                              className="icon-1x1-xsmall w-embed"><svg width="24" height="24" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="24" height="24" rx="4" fill="#006AFF" />
                                <path
                                  d="M17.8169 12.2189C15.0709 12.9007 12.9064 15.0646 12.2243 17.817C12.1633 18.061 11.8367 18.061 11.7757 17.817C11.0972 15.0646 8.9327 12.9007 6.18307 12.2189C5.93898 12.1579 5.93898 11.8313 6.18307 11.7703C8.92911 11.0921 11.0936 8.93182 11.7757 6.18301C11.8367 5.939 12.1633 5.939 12.2243 6.18301C12.9028 8.93182 15.0673 11.0921 17.8169 11.7703C18.061 11.8313 18.061 12.1579 17.8169 12.2189Z"
                                  fill="white" />
                              </svg></div>
                            <div className="nav_dd_link-title">AI Video Assistant</div>
                            <div className="nav_dd_link_subtitle">AI sales assistant gives tailored advice, anticipating
                              customer needs.</div>
                          </div>
                        </a>
                        {/* ... other product links ... */}
              ...
              {/* ... other dropdowns (Solutions, Resources) ... */}
              <a href="https://firework.com/plans/" id="nav-pricing-link"
                className="nav_link w-variant-6c5a36d4-fb94-3a14-f3f1-62e8a56848cf pricing">Pricing</a>
              <a href="https://firework.com/partnerships/" id="nav-partners-link"
          ...
          <div id="w-node-_92c48947-d98a-4b7d-e09e-72ff8154026c-81540260" className="nav_burger_button">
            <a
              ...
              <div data-is-ix2-target="1" className="nav_burger-lottie" data-w-id="92c48947-d98a-4b7d-e09e-72ff8154026e"
                data-animation-type="lottie"
                data-src="https://cdn.prod.website-files.com/633bfcc4d9e4e23b44279dab/646e01cdfba05964dcf0d4eb_menu%20burger.json"
                data-loop="0" data-direction="1" data-autoplay="0" data-renderer="svg" data-default-duration="4"
                data-duration="0" data-ix2-initial-state="24"></div>
            </a>
